...
def generate_ontology():
    """
    Endpoint 1: Upload files and analyze to generate an ontology definition
...
def build_graph():
    """
    Endpoint 2: Build a graph based on project_id
    ...
    try:
        ...
        def build_task():
            ...
            try:
                ...
                # Wait for Zep processing to complete (poll processed status of each episode)
                task_manager.update_task(
                    task_id,
