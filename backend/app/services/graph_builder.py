...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        """
        Asynchronously build the graph
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This usage is required by the Zep SDK; the warning originates from dynamic class creation and can be safely ignored
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # The Zep API requires Field description; this is mandatory
        ...
        # Call the Zep API to set the ontology
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Retrieve complete graph data (including detailed information)
        ...
        # Create a node map for looking up node names
        node_map = {}
        for node in nodes:
