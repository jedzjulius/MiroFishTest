...
class ZepEntityReader:
    ...
    2. Filter nodes that match predefined entity types (nodes whose Labels are not solely "Entity")
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all edges in the graph (with pagination)
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If a node's Labels contain only "Entity", the entity does not match our predefined types and is skipped
        - If a node's Labels contain labels other than "Entity" and "Node", it matches a predefined type and is kept
        ...
        Returns:
            FilteredEntities: The collection of filtered entities
        """
        ...
        # Get all edges (for subsequent relationship lookups)
        ...
        for node in all_nodes:
            ...
            # Filter logic: Labels must include at least one label other than "Entity" and "Node"
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity and its full context (edges and associated nodes, with retry logic)
