...
class SimulationManager:
    ...
    # Directory for storing simulation data
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No entities matching the criteria were found. Please verify that the graph was built correctly."
                self._save_simulation_state(state)
                return state
            ...
            # Set the real-time save file path (Reddit JSON format takes priority)
            ...
            # Reddit profiles were already saved in real time during generation; saving again here ensures completeness
            if progress_callback:
                progress_callback(
            ...
            # When starting a simulation, simulation_runner will execute scripts from the scripts/ directory.
