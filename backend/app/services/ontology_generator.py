...
Interface 1: Analyze text content and generate entity and relation type definitions
...
- We need to simulate how each party reacts and how information spreads in opinion events.
...
A. **Fallback types (required, placed last in the list)**:
   - `Person`: Fallback type for any individual person. Use when a person does not fit any other specific person type.
   - `Organization`: Fallback type for any organization. Use when an organization does not fit any other specific organization type.
...
- The text may contain various people who don't fit specific types (e.g. ordinary teachers, anonymous netizens).
- These should be classified under `Person`.
...
- The description must clearly distinguish the specific type from the fallback type.

### 2. Relation Type Design

- Quantity: 6–10 types
- Relations should reflect real connections in social media interactions.
- Ensure the source_targets of relations cover the entity types you have defined.
...
class OntologyGenerator:
    ...
    # Max text length passed to the LLM (50,000 characters)
...
"""
        ...
        message += """
Based on the content above, design entity types and relation types suitable for social opinion simulation.
...
4. All entity types must be real-world actors that can speak; they cannot be abstract concepts.
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Map original names to PascalCase, used to fix edge source_targets references
        entity_name_map = {}
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        """
        Convert ontology definition to Python code.
