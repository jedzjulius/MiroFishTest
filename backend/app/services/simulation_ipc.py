...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Returns:
            IPCResponse with interview results in the result field
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional; can be overridden by the platform field of each interview item)
                - "twitter": Default to interviewing Twitter platform only
                - "reddit": Default to interviewing Reddit platform only
                - None: In a dual-platform simulation, each agent is interviewed on both platforms simultaneously
            timeout: Timeout in seconds
